...
export class JogoDaVelhaService {
  ...
  private readonly X: number = 1; //Marcador do Usuario ou CPU
   ...
   */
  inicializar(): void {
    this._showInicio = true; //tela inicial TRUE,usado no .html para exibir as telas
    this._showTabuleiro = false;
    this._showFinal = false;
    this.numMovimentos = 0;
    this._jogador = this.X;
    this.vitoria = false;
    //chama outra funcao InicializarTabuleiro()
